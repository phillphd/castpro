...
// 		add_filter( 'get_twig', array( $this, 'add_to_twig' ) );
	...
	function lf_cleanup() {
  	...
  	function register_scripts() {
  		global $package_version;
  		wp_enqueue_script('jquery', 'https://code.jquery.com/jquery-3.2.1.slim.min.js', array(), $package_version, true);
  		wp_enqueue_script('application-js', get_template_directory_uri() . '/assets/dist/js/script.min.js', array('jquery'), $package_version, true);
  	}
